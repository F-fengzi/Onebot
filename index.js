...
var ch = false;
const words = ["Oh","Hello","Hi","One","Apple","Banana","Pear","Grapes","Food","Cloth","AMD","TV","Fengzi","No","Yes","Nah","Keyboard","Mouse","Memory","Motherboard","Storage","CPU","GPU","Graphics card","Power supply","Monitor","Google","Duckduckgo","Dogs","Cats","Ducks","Testie","Charlie","Website","CHINA","Hmm","Umm","Sofa","Floor","Water","Lava","Minecraft","Mojang","Bugjang","Undertale","Bilibili","Youtube","Desk","Earphones","Headphone","Lamp","Switch","Box","Pencil","Doge","Wall","Sky","Grass","Lakes","Cloud","Ground","Microsoft","Macrosoft","Windows","Linux","Music","Dance","Printer","House","Tomato","Potato","Discord","Bot","Java","Javascript","HTML","CSS","Python","C","C++","Doors","Drawer","Locker","Done","Much","More","Such","Many","Uhh","Oof","Yay","Yeeee","Bed","Spam","Things","Yeah","Stable","Unstable","Notepad","VSCode","Birthplace","Server","Raspberry","Pie","Blueberry","Raspberry Pi","Meme","Brother","Sister","Dictionary","Rain","Cloudy","Fog","Mountains","Hill","Heal","Dew","Bamboo","Trees","Birds","Sunny","Channel","Minceraft","Notch","Words","Alphabet","Letters","Console","Pog","Client","Log","Apps","Application","Message","Software","Hardware","Open source","Open sauce","Rip","Processor","Architecture","Ryzen","Zen","WeChat","QQ","Facebook","Messenger","Instagram","Text","Lab","Android","Amazon","Advanced","Onebot","Ready","True","False","Agreed","On","Off","What","Where","When","Why","Who","Whose","Open","Close","Speaking","Talking","Saying","Walking","Riding","Thinking","Coding","Programming","Running","Swimming","Wow","Asking","Pool","Them","He","She","Him","Her","They","Returning","Return","Forward","Back","Lower","Higher","Command","Stop","Content","Sent","Help","**SOS**","Shutdown","Restart","Start","Shut","Boot","Boat","Ship","Sea","Ocean","Version","Spam","Spamming","Case","Universe","Stars","Empty","Full","Fire","Logo","Design","Slave","White","Black","Grey","All","Again","Air","Gas","Liquid","Solid","Energy","Electric","Waves","Light","Dark","Verification","Affirm","Confirm","Money","Gold","Tencent","Alibaba","Baidu","Cooling","Fan","Wires","Impostor","Space","Spring","Summer","Fall","Winter","Invite","That","There","Those","This","Here","These","Set","Changed","ID","Card","Core","Token","Leak","Reveal","Random","World","If","Phew","Hack","Disorder","Translate","Cheat","Search","Order","Engine","Bullshit","Sound","Smell","Feel","Touch","Old","New","Free","Paid","Ubuntu","Debian","Raspbian","Fedora","Mint","Manjaro","Deepin","Mac","MacOS","Adding","Typing","Deleting","Praying","Waiting","Hope","Few","Only","Lonely","Books","Chat","Working","Studying","Saving","listening","Rescue","Wish","Now","Later","*Comes*","Run","Welcome","Camera","Phone","Notification","Story","Name","About","Mode","Update","Upgrade","System","Complex","Simple","Nice","Good","Great","Sure","Visual","Taste","Studio","Code","Program","Vanilla","Spigot","Paper","Wood","Oxygen","Metal","Intel","Nvidia","Silicon","Tesla","SpaceX","Starlink","Laptop","Desktop","iOS","iPadOS","watchOS","macOS","tvOS","Carbon","Earth","Moon","Sun","Mars","Mercury","Venus","Jupiter","Saturn","Uranus","Neptune","Pluto","Warm","Warming","Cold","Temperature","Weight","Mass","Density","Length","Width","Station","Screen","Display","Plane","Rocket","Airship","Car","Vehicle","Bike","Bicycle","Submarine","Heart","Lung","Stomach","Hands","Feet","Legs","Arms","Fingers","Hair","Eyes","Nose","Mouth","Ears","Head","Face","Neck","Body","Skin","Sentence","Grammar","Happy","Angry","Sad","Determination","Blocks","Square","Triangle","Polygon","Fun","Funny","Photoshop","Calendar","Cortana","Siri","Alexa","Assistant","Bixby","Maps","Movies","Feedback","Virus","Antivirus","Office","Word","PowerPoint","Excel","Git","Github","Chrome","Support","Java","Jvav","Calculator","Microphone","Screenshot","Record","Mail","Email","Whiteboard","Blackboard","Edge","Store","Education","Edition","English","Chinese","Node","Alarm","Clock","VPN","Outlook","Games","Settings","Weather","Notes","Technique","Wallpaper","Graphics","Control","Panel","Photos","Text","Audio","Images","Videos","String","Object","Array","Functions","Variables","Hey"];
